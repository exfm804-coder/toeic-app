...
export default function ListPage({ datasetId, questions, onSelect, reviewed, onBack, initialPart = null, isAttempt = false }) {
  ...
  const showWrongFilter = isAttempt || !PREBUILT_WRONG_ANSWER_DATASETS.has(datasetId)
